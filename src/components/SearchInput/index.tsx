  ...
  return (
    <div className="relative inline-block text-left w-full">
      <div className='relative'>
        ...
        <input onFocus={() => setState(!state)} onBlur={() => setState(!state)} className="inline-flex w-full justify-center rounded-lg border border-solid border-gray-300 bg-white px-4 py-2 pl-10 font-medium text-gray-700 focus:rounded-lg focus:shadow-purple-action focus:outline-none focus:ring-4 focus:ring-purple-30 focus:ring-offset-[0.5px] focus:ring-offset-purple-300" id="menu-button" placeholder='Search' />
      </div>
